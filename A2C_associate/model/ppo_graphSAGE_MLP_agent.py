...
def train_agent(env, agent: PPOAgent, results_dir: str):
    ...
    for ep in range(1, MAX_EPISODE + 1):
        ...
        # Cho phep UE thay doi o day 
        # Thay doi dinh nghia sate, action, reward 
        # UE thay doi thi xu ly UE maping, resource allocation, UE accepted/ UE chua dc ket noi vao mang
